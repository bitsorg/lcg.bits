...
##############################
function Configure() {
  # DDML's find_package(MPI) locates wrappers via mpicxx on PATH, which bits
  # doesn't add -> "Could NOT find MPI". Put OpenMPI's bin on PATH and set
  # OPAL_PREFIX (its runtime root).
