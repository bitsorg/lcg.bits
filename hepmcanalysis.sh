...
description: hepmcanalysis Monte Carlo event generator
version: "3.4.14"
tag: "3.4.14"
sources:
...
function Make() {
  ...
  cmake -E copy_directory $SOURCEDIR/lib $INSTALLROOT/lib COMMAND cmake -E copy_directory $SOURCEDIR/include $INSTALLROOT/include
}