...
---
#!/bin/bash -e
# Collect PKG_CONFIG_PATH from every bits *_ROOT so cairo.pc's transitive Requires
# (pixman-1, fontconfig, ...) resolve -- module prepend_path only adds direct deps. The
# lib/*/pkgconfig glob also covers old builds under lib/<triple>/pkgconfig.
