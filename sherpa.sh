...
##############################
# Sherpa 3 builds Python bindings with SWIG; set SWIG/SWIG_LIB at recipe scope as
# lcgcmake does. bits_swig_lib returns the relocated swiglib on macOS (swig's
# compiled-in path points at the gone build INSTALLROOT after relocation).
