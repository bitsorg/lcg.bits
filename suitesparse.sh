...
function Make() {
  ...
  # -L$PWD/lib: modules link -lsuitesparseconfig from the source tree's lib/, which
  # our LDFLAGS override would otherwise drop (INSTALLROOT/lib is empty until the
  # install step).
